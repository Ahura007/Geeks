...
internal class DbContext
{
    ...
    public static List<SeminarGroup> Classes { get; set; } = [];
    ...
    public static void SeedData()
    {
        ...
        var c2 = SeminarGroup.Create(Lessons[1]!.Id, tomorrow.AddHours(12), tomorrow.AddHours(14), 120,
            ClassType.Virtual,
            "https://vc.BBB.ir/b/mah-upw-4fk");

        var c3 = SeminarGroup.Create(Lessons[2]!.Id, tomorrow.AddDays(1).AddHours(12), tomorrow.AddDays(1).AddHours(14),
            1,
